    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 0) {
                ...
                // Direction indicator
                DirectionIndicator(status: connection.lastStatus)
                    .padding(.bottom, 24)

                // Main drive buttons — large for mounted use
                HStack(spacing: 24) {
                    DriveButton(
                        icon: "arrow.left",
                        label: "Back",
...
// MARK: - Drive Button (hold to drive)
    ...
    var body: some View {
        HStack(spacing: 40) {
            ...
            VStack(spacing: 2) {
                ...
                Text("\(Int(Double(status.speed)/255*100))% speed")
                    .font(.caption)
...
struct NotConnectedBanner: View {
    var body: some View {
        HStack {
            ...
            Text("Not connected — go to Connect tab")
                .font(.subheadline)
        }
        .foregroundColor(.white)
        .padding(10)
