        ...
        NavigationView {
            Form {
                ...
                Section {
                    ...
                    Button { showRunPicker = true } label: {
            ...
            .sheet(isPresented: $showRunPicker) {
                RunPickerView { run in
                    entries.append(SetEntry(runID: run.id, restDuration: restDuration))
                }
            }
            .onAppear {
